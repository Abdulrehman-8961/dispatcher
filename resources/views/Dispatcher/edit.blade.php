...
@section('main')
    @php
        ...
        $trucks = DB::table('truck')
            ...
            ->where('is_deleted', 0)
            ->get();
        $truck_selected = explode(',', @$data->truck_id);
    @endphp
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="container">
                <form action="{{ url('updatedispatcher/' . $data->id) }}" method="POST" id="saveDispatcherForm">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" value="{{ $data->dispatcher_name }}" name="dispatcher_name"
                                    id="dispatcher_name" placeholder="Dispatcher Name" value="{{ old('dispatcher_name') }}"
                                    class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="selectpickerMultiple" class="form-label">Trucks <span
                                    class="imp_fields">*</span></label>
                            <select name="truck_id[]" id="truck_id" class="selectpicker w-100" data-style="btn-default"
                                ...
                                @foreach ($trucks as $item)
                                    <option value="{{ $item->id }}"
                                        {{ in_array($item->id, $truck_selected) ? 'selected' : '' }}>
                                        {{ $item->truck_number }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" value="{{ $data->salary }}" name="salary" id="salary"
                                    class="form-control" value="{{ old('salary') }}" placeholder="Percentage / Salary"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" value="{{ $data->routing_number }}" name="routing_number"
                                    id="routing_number" class="form-control" value="{{ old('routing_number') }}"
                                    placeholder="Routing #" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" value="{{ $data->account_number }}" name="account_number"
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" value="{{ $data->driver_license_number }}"
                                    name="driver_license_number" id="driver_license_number" class="form-control"
                                    value="{{ old('driver_license_number') }}" placeholder="Driver Licenses #" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" value="{{ $data->ssn_number }}" name="ssn_number" id="ssn_number"
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="file" name="driver_licenses" id="driver_licenses" class="form-control"
                                    value="{{ old('driver_licenses') }}" placeholder="Driver Licenses" >
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#saveDispatcherForm').submit(function(e) {
                ...
                $.ajax({
                    url: "{{ url('updatedispatcher/' . $data->id) }}",
                    method: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
