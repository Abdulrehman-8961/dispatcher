                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    @endphp
                                        <tr class="@if($expiryDate < $currentDate) bg-danger text-white @elseif($expiryDate <= $thirtyDaysFromNow) background-color  @endif"
                                        >
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-2">
                            <div class="col mb-0">
                                ...
                                <select name="truck" class="form-control select2" id="dispatcher_account">
