...
@section('main')
                                ...
                                <div class="form-check custom-option custom-option-basic">
                                    <label class="form-check-label custom-option-content" for="customCheckTemp3">
                                        ...
                                        <span class="custom-option-header">
                                            <span class="h6 mb-0">Add Custom Invoice</span>
                                        </span>
                                    </label>
                                </div>
                            </div>
                                        ...
                                        <div class="col-6">
                                            <table id="data">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td id="invoice"><input name="invoice_no" readonly
                                                                value="{{ $invoice_no }}" class="form-control invoice_no"
    ...
    <script>
        $('#customCheckTemp3').on('change', function() {
                if ($(this).is(':checked')) {
                    // Checkbox is checked
                    $('.invoice_no').addClass('d-none');
                    var inputField = `<input name="custom_invoice" required class="form-control custom_invoice" style="border:none;height:20px" placeholder="Invoice #">`;
                    $('#invoice').append(inputField);
                } else {
                    // Checkbox is unchecked
                    $('.custom_invoice').remove();
                    $('.invoice_no').removeClass('d-none');
                }
            });
