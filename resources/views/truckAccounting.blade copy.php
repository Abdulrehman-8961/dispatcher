                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive income">
                                            ...
                                            <tbody class="repeater">
                                                ...
                                                @else
                                                    <tr>
                                                        ...
                                                        <td><input type="checkbox" class="is_eight percent"
                                                                data-value="{{ $settings->value_1 }}%" value="1"></td>
                                                        <td><input type="checkbox" class="is_three percent"
                                                                data-value="{{ $settings->value_2 }}%" value="1"></td>
                                                        <td><a href="javascript:;" class="remove" class="text-danger"><i
                                                                    class="fa fa-times"></i></a></td>
                                                    </tr>
                                                @endif
                                        ...
                                        <button class="btn btn-primary mt-3 add-more btn-sm"><i class="fa fa-plus"></i> Add
                                            More</button>
                                    </div>
                                </div>
        ...
        <td>` + (total_income - total_expense) + `</td>
            ...
            $('.send-mail').on('click', function() {
                ...
                if (id) {
                    ...
                    $('#week_no').val(week);
                    $('#year_no').val(year);
                    $('#addNewCCForm').attr('action', '{{ url('sendTruckAccountingPDF/') }}/' + id + '@if (request()->has("week"))?week={{ request("week") }} @endif');
                }
            })
