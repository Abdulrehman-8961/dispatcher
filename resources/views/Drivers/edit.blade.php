...
@section('main')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            @endphp
            <div class="container">
                <form action="{{ url('updatedriver/' . $data->id) }}" method="POST" id="saveDriverForm">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" value="{{ $data->driver_name }}" name="driver_name" id="driver_name"
                                    placeholder="Driver Name" value="{{ old('driver_name') }}" class="form-control" required>
                            </div>
                        </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="truck_id" class="form-select" id="truck_id" required>
                                    @foreach ($truck as $item)
                                        <option value="{{ $item->id }}" <?php if ($item->id == $data->truck_id) {
                                            echo 'selected';
                                        } ?>>{{ $item->truck_number }}
                                        </option>
                                    @endforeach
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="phone" id="phone" value="{{ $data->phone }}"
                                    class="form-control" value="{{ old('phone') }}" placeholder="Phone" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="license" value="{{ $data->driver_license }}" id="license"
                                    class="form-control" value="{{ old('license') }}" placeholder="Driver License" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="license_issue_date" value="{{ $data->license_issue_date }}"
                                    id="license_issue_date" class="form-control" value="{{ old('license_issue_date') }}"
                                    placeholder="Driver License Issue Date" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="license_expiry_date" value="{{ $data->license_expiry_date }}"
                                    id="license_expiry_date" class="form-control" value="{{ old('license_expiry_date') }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="medical_issue_date" value="{{ $data->medical_issue_date }}"
                                    id="medical_issue_date" class="form-control" value="{{ old('medical_issue_date') }}"
                                    placeholder="Medical Certificate Issue date" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="medical_expiry_date"
                                    value="{{ $data->medical_expiry_date }}" id="medical_expiry_date"
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="">SSN #</label>
                                <input type="text" name="ssn_number" id="ssn_number" value="{{ $data->ssn }}"
                                    class="form-control" value="{{ old('ssn_number') }}" placeholder="SSN #" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="">Hired Date <span class="imp_fields">*</span></label>
                                <input type="date" name="hired_date" id="hired_date" value="{{ $data->hired_date }}"
                                    class="form-control" value="{{ old('hired_date') }}" placeholder="SSN #" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="file" name="medical_card" id="medical_card" class="form-control"
                                    value="{{ old('medical_card') }}" placeholder="Medical Card" >
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="">Drug Test</label>
                                <input type="file" name="drug_test" id="drug_test" class="form-control"
                                    value="{{ old('drug_test') }}" placeholder="Drug Test" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="file" name="employment_app" id="employment_app" class="form-control"
                                    value="{{ old('employment_app') }}" placeholder="Driver Employment Application" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="file" name="clearing_house" id="clearing_house" class="form-control"
                                    value="{{ old('clearing_house') }}" placeholder="Clearing House" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="file" name="orentation" id="orentation" class="form-control"
                                    value="{{ old('orentation') }}" placeholder="Orientation" >
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="file" name="emergency_contact" id="emergency_contact"
                                    ...
                                    placeholder="Emergency Contact Form" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="file" name="ssn_pic" id="ssn_pic" class="form-control"
                                    value="{{ old('ssn_pic') }}" placeholder="SSN" >
                            </div>
                        </div>
                    </div>
                    <div class="row mt-2">
