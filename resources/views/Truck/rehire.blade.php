...
@section('main')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Trucks /</span> Old Trucks</h4>
        @php
            if (isset($_GET)) {
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="javascript:void(0);" data-id="{{ $o->id }}"
                                                class="dropdown-item rehire_btn">Re-Hire</a>
    ...
    <script>
        $('body').on('click', '.rehire_btn', function() {
            ...
            window.location = "{{ url('rehire/truck') }}/" + rehireId;
        })
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res) {
                        ...
                        var termination_letter = '';
                        if (res.termination_letter != null) {
                            var link_termination_letter = "{{ asset('public/uploads') }}/" + res.termination_letter;
                            var fileNameParts = res.termination_letter.split('.');
                            var fileExtension = fileNameParts[fileNameParts.length - 1];
                            if (fileExtension != 'pdf') {
                                termination_letter = '<a href="' + link_termination_letter + '" download><img src="' +
                                    link_termination_letter + '" class="img w-100"/></a>';
                            } else {
                                termination_letter = '<a href="' + link_termination_letter +
                                    '"><span class="badge bg-label-primary rounded-pill ms-auto">Download Pdf</span></a>';
                            }
                        }
                        var physical_damage = '';
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12"><h5 class="mb-1">Termination Letter:</h5>` + termination_letter + `</div>
                            </div>
