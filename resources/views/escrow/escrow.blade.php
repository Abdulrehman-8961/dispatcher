...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Escrow</h4>
    @php
    ...
    if(isset($_GET['year'])){
      ...
      $truck = DB::table('truck')
        ->orderBy('id', 'asc')->where('escrow_return', 0)
        ->get();
} else {
          ...
          <tbody class="table-border-bottom-0">
            ...
            @endphp
                ...
                <tr>
                    ...
                    <td>{{$escrow_amount}}</td>
                    <td><?php if(isset($o->quite_date)){echo date('M-d-Y' , strtotime($o->quite_date));} ?> </td>
                    <td>{{$modifiedDate}}</td>
                    <td>
