...
@section('main')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="container">
                <form action="{{ url('SaveOwner') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="company" id="company" class="form-control"
                                    value="{{ old('company') }}" placeholder="Comapny Name" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="owner_name" id="owner_name" class="form-control"
                                    value="{{ old('owner_name') }}" placeholder="Owner Name" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="ssn" id="ssn" class="form-control"
                                    value="{{ old('ssn') }}" placeholder="EIN/SSN" required>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="routing_number" id="routing_number"
                                        value="{{ old('routing_number') }}" placeholder="Routing #" class="form-control"
                                        required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="account_number" id="account_number"
                                        value="{{ old('account_number') }}" placeholder="Account #" class="form-control"
                                        required>
                                </div>
                            </div>
                        </div>
