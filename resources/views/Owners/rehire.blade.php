...
@section('main')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Old Owners</h4>
        @php
            if (isset($_GET)) {
                ...
                $owners = DB::table('owners')->where('is_deleted', 1);
                ...
                <table class="table mb-5">
                    <thead>
                        <tr>
                            ...
                            <th><a
                                    href="{{ url()->current() }}?{{ isset($_GET['search']) ? 'search=' . $_GET['search'] : '' }}&orderBy={{ @$_GET['orderBy'] == 'desc' ? 'asc' : 'desc' }}&field=company_name">Company</a>
                            </th>
                            <th><a
                                    href="{{ url()->current() }}?{{ isset($_GET['search']) ? 'search=' . $_GET['search'] : '' }}&orderBy={{ @$_GET['orderBy'] == 'desc' ? 'asc' : 'desc' }}&field=owner_name">Owner
                                    Name</a></th>
                            <th>Address</th>
                            <th>Phone</th>
                            <th><a
    ...
    <script>
        $('body').on('click', '.rehire_btn', function() {
            ...
            window.location = "{{ url('rehire/owner') }}/" + rehireId;
        })
                    ...
                    if (res) {
                        ...
                        <div class="row">
                          <div class="col-md-4"><h5>Routing #</h5><p>` + res.routing + `</p></div>
                            ...
                            <div class="col-md-12"><h5>License:</h5><a href="` + path +
                            `" download="download"><img src="` + path + `" class="img w-100"/></a></div>
                        </div>
                        `
